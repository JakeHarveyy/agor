...
export const externalRuns = pgTable(
  'external_runs',
  {
    run_id: varchar('run_id', { length: 36 }).primaryKey(),
    created_by: varchar('created_by', { length: 36 }).references(() => users.user_id, {
      onDelete: 'set null',
    }),
    ...
    primary_branch_id: varchar('primary_branch_id', { length: 36 }).references(
      () => branches.branch_id,
      { onDelete: 'set null' }
    ),
    summary_document_id: varchar('summary_document_id', { length: 36 }).references(
 ...
 */
export const externalRunEvents = pgTable(
  'external_run_events',
  {
 ...
 */
export const externalRunLinks = pgTable(
  'external_run_links',
  {
